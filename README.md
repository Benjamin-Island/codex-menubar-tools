...
- [Download Codex Menu Bar v0.3.5](https://github.com/Benjamin-Island/codex-menubar-tools/releases/download/v0.3.5/CodexMenuBar-v0.3.5-apple-silicon.zip)
- [SHA-256 checksum](https://github.com/Benjamin-Island/codex-menubar-tools/releases/download/v0.3.5/CodexMenuBar-v0.3.5-apple-silicon.zip.sha256)

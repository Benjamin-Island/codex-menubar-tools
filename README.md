...
- [Download Codex Menu Bar v0.3.11](https://github.com/Benjamin-Island/codex-menubar-tools/releases/download/v0.3.11/CodexMenuBar-v0.3.11-apple-silicon.zip)
- [SHA-256 checksum](https://github.com/Benjamin-Island/codex-menubar-tools/releases/download/v0.3.11/CodexMenuBar-v0.3.11-apple-silicon.zip.sha256)
...
| --- | --- | --- |
| [v0.3.11](https://github.com/Benjamin-Island/codex-menubar-tools/releases/tag/v0.3.11) | 2026-07-28 | Explicit repair for Screen Recording grants invalidated by preview updates |

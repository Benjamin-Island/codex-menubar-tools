...
- [下载 Codex Menu Bar v0.3.8](https://github.com/Benjamin-Island/codex-menubar-tools/releases/download/v0.3.8/CodexMenuBar-v0.3.8-apple-silicon.zip)
- [SHA-256 校验值](https://github.com/Benjamin-Island/codex-menubar-tools/releases/download/v0.3.8/CodexMenuBar-v0.3.8-apple-silicon.zip.sha256)
